...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tblr}{
            ...
            \hline
            \mbiebf{2a. Research publications and dissemination}                         \\
            \hline
            \mbiebf{Peer-reviewed journal articles}, \href{https://orcid.org/\orcididnum}{\textit{ORCID:\orcididnum}} \\
            \hline
        \end{tblr}
    \end{table}
    ...
    \headertable[H]{Key conference proceedings}
    \printbibliography[heading=none, filter=confrencepro]

    \headertable[H]{Other forms of relevant dissemination (reports for clients, technical reports, popular press, etc)}
